...
const SubjectAboveMajority: React.FC<{ students: Student[] }> = ({ students }) => {
    ...
    const findSubjectsAboveAverage = () => {
        ...
        const subjectsWithMajorityAboveAverage = Object.keys(aboveAverageCounts).filter(
            subject => aboveAverageCounts[subject] >= majorityThreshold
        );
