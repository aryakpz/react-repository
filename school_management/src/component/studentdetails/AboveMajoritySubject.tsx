...
const PercentageAboveSpecificInMajority: React.FC<PercentageAboveSpecificInMajorityProps> = ({ students, selectedStudent }) => {
    const [percentageAboveMajority, setPercentageAboveMajority] = useState<number | null>(null);
