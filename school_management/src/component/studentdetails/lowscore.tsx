...
const LowScorerDisplay: React.FC<TopScorerDisplayProps> = ({ students, subject }) => {

    const lowscore =students.reduce((min, student) => {
    ...
    return (
        <p>
            <span>Lowest score in {subject}:</span> {lowscore.name} - {lowscore.mark}</p>
    );
};
