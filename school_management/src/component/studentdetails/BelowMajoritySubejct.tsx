...
const PercentageBelowSpecificInMajority: React.FC<PercentageBelowSpecificInMajorityProps> = ({ students, selectedStudent }) => {
    const [percentageBelowMajority, setPercentageBelowMajority] = useState<number | null>(null);
