...
const LowestPercentageAboveAverage: React.FC<LowestPercentageAboveAverageProps> = ({ students, selectedStudent }) => {
    ...
    const calculateLowestPercentageSubjects = () => {
        ...
        const lowestPercentage = Math.min(...subjectPercentagesResult.map(sub => sub.percentage));
