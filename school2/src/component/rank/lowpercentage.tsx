...
const LowestPercentageStudent: React.FC<LowestPercentageStudentProps> = ({ students, subject }) => {
    const maxMark = 100; 

    const lowestScorer = students.reduce((acc, student) => {
    ...
    if (lowestScorer.names.length === 0) return <p>No students found for the subject {subject}.</p>;
