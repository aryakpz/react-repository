...
const Specificstudentpercentage: React.FC<AboveAveragePercentageProps> = ({ students, selectedStudent }) => {
    const [aboveAveragePercentages, setAboveAveragePercentages] = useState<{ subject: string; percentage: number }[]>([]);
