...
const HighestPercentageSubjects: React.FC<HighestPercentageSubjectProps> = ({ students, selectedStudent }) => {
    ...
    const calculateHighestPercentageSubjects = () => {
        ...
        const highestPercentage = Math.max(...subjectPercentagesResult.map(sub => sub.percentage));
        const subjectsWithHighestPercentage = subjectPercentagesResult.filter(({ percentage }) => percentage === highestPercentage);
