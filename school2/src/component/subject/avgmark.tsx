...
const StudentAverage: React.FC<StudentAverageProps> = ({ students, selectedStudent }) => {
    ...
    const average = student.marks.reduce((total, mark) => total + mark.mark, 0) / student.marks.length;
